...
declare -a othersrc=("test"
                     "T-override-final-const-trailing"
                     "test-virtual-lookup")
...
do
  ...
  then
    TMPSTR="$TMPSTR Quote3.cpp Bulk_quote5.cpp"
  elif [ "$i" == "exer15-7" ]
  then
    TMPSTR="$TMPSTR Quote3.cpp Bulk_quote5.cpp Limit_quote7.cpp"
  elif [ "$i" == "exer15-11" ]
  then
    TMPSTR="$TMPSTR Quote11.cpp Bulk_quote11.cpp Limit_quote11.cpp"
  elif [ "$i" == "exer15-16" ]
  then
    TMPSTR="$TMPSTR Quote16.cpp Disc_quote16.cpp Bulk_quote16.cpp Limit_quote16.cpp"
  elif [ "$i" == "exer15-26" ]
  then
    TMPSTR="$TMPSTR Quote26.cpp Disc_quote26.cpp Bulk_quote26.cpp Limit_quote26.cpp"
  elif [ "$i" == "exer15-28" ]
  then
    TMPSTR="$TMPSTR Quote28.cpp Disc_quote28.cpp Bulk_quote28.cpp Limit_quote28.cpp"
  elif [ "$i" == "exer15-30" ]
  then
    TMPSTR="$TMPSTR Basket30.cpp Quote30.cpp Disc_quote30.cpp Bulk_quote30.cpp Limit_quote30.cpp"
  elif [ "$i" == "exer15-35" ]
  then
    TMPSTR="$TMPSTR "
