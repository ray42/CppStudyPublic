...
public:
  ...
  StrBlobPtr begin(); // can't be defined until StrBlobPtr is. TODO, define, test
  StrBlobPtr end();   // can't be defined until StrBlobPtr is. TODO, define, test
  ConstStrBlobPtr cbegin(); // can't be defined until ConstStrBlobPtr is. TODO, define, test
  ConstStrBlobPtr cend();   // can't be defined until ConstStrBlobPtr is. TODO, define, test
