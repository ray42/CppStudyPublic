...
////////////////////////////////////////////////////////////////////////////
// ex30 dereference and arrow operator

// we will return a reference to the string currently pointed to by curr.
...
// We will return a pointer to the underlying string pointed to by curr.
// That way, we can access all the string member functions.
// We cannot return a string object because the std::string class does not
